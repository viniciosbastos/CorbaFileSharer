...
public abstract class P2PPOA extends org.omg.PortableServer.Servant
 implements P2POperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // FileSharer/P2P/downloadFile
       {
         String fileName = in.read_string ();
         byte $result[] = null;
         $result = this.downloadFile (fileName);
         out = $rh.createReply();
         ByteArrayHelper.write (out, $result);
         break;
       }
